...
% 
%   if isempty(eom_func)
%     % Declare symbolic variables for the states and input
%     syms ddth ddphi th phi dth dphi u
% 
%     % Equation 1
...
% 
%     % Create a numeric function from the symbolic solution
%     eom_func = matlabFunction([sol.ddth; sol.ddphi], 'Vars', {th, phi, dth, dphi, u});
%   end
% 
%   % Call the precomputed function with numeric values
%   qdd = eom_func(th, phi, dth, dphi, u);
% end
